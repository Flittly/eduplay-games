...
function unproject(x, y) {
	...
	return {
		lat: Math.asin(Math.max(-1, Math.min(1, sinPhi))) / RAD,
...
/** 网格格点（中心）的经纬度 */
function gridToLonLat(g, gi, gj) {
	const p = gridToXY(g, gi, gj);
	return unproject(p.x, p.y);
}
//#endregion
exports.ALBERS = ALBERS;
exports.WORLD_UNIT_KM = WORLD_UNIT_KM;
exports.gridToLonLat = gridToLonLat;
exports.gridToXY = gridToXY;
exports.makeGrid = makeGrid;
exports.project = project;
exports.projectBounds = projectBounds;
